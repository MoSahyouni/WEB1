(() => {
  ...
  <ul id="list">
    ...
    <li>AAnzahl der Sitzpl\xE4tze pro Tisch: <input id="plaetzeProTisch", type="text" ></li>
  ...
  <p id="userdata"></p>`;
    ...
    function plgastordnerlistPrint(rTische, sitzeProTisch, bestuhlung, plgastordnerlist, vername) {
      ...
      header2.innerHTML = '<h5 id="back">zur\xFCck</h5><h2>Veranstaltungsplanner</h2><h5>  f\xFCr die Veranstaltung ' + vername + " gibt es " + rTische + " Tische und " + sitzeProTisch + " Sitzplatz pro Tisch. Tische haben " + bestuhlung + " bestuhlung.";
  ...
  function ButtonBack() {
    const header2 = document.getElementById("bodyheader");
    header2.innerHTML = '<h5 id="back">zur\xFCck</h5><h2>Veranstaltungsplanner</h2>';
    const btnBack = document.getElementById("back");
    btnBack.addEventListener("click", () => {
      window.location.reload();
    });
